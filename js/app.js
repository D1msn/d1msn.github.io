...
// let pages = new Swiper(".page__slider", {
//   direction: "vertical",
//   sliderPerView: 1,
//   spaceBetween: 0,
//   mousewheel: true,
...
let slider_about = new Swiper(".links-slider", {
  /*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
function nextSlide() {
  ...
  gsap.to(".page", {
    ...
    // ease: "power4.out",
    duration: 0.4,
    background: "linear-gradient(0deg, rgba(0, 8, 31, .98) -60%, rgba(0,0,0,0.15) 120%)",
  });
}
...
function previousSlide() {
  ...
  gsap.to(".page", {
    ...
    // ease: "power4.out",
    duration: 0.4,
    background: "linear-gradient(0deg, rgba(255, 255, 255, 0) -130%, rgba(0, 8, 31, 0.98) 140%)",
  });
}
...
function touchend(event) {
  if (event.changedTouches[0].clientY > yStart + 50) {
    previousSlide();
  } else if (event.changedTouches[0].clientY < yStart - 50) {
    nextSlide();
  }
}
...
const navLine = gsap.timeline({
  paused: true,
});

navLine.to(".nav__line", {
  duration: 0.3,
  scaleY: 1,
  transformOrigin: "top",
